...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "q", quitmenu,
              {description = "quit menu", group = "awesome"}),
    ...
    -- Power Off button
    awful.key({}, "XF86PowerOff", function () myquitmenu:show() end, {description = "quit menu", group = "awesome"}),
    -- Clipmenu
